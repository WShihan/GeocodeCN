...
class Ui_GeocodeCNDialogBase(object):
    def setupUi(self, GeocodeCNDialogBase):
        ...
        GeocodeCNDialogBase.resize(593, 763)
        ...
        self.horizontalLayout_4 = QtWidgets.QHBoxLayout(self.gbBatch)
        ...
        self.cb.setMinimumSize(QtCore.QSize(80, 30))
        self.cb.setMaximumSize(QtCore.QSize(110, 30))
        ...
        self.btn_start.setMaximumSize(QtCore.QSize(120, 40))
        font = QtGui.QFont()
        font.setFamily("黑体")
        ...
        self.leAddress.setMaximumSize(QtCore.QSize(800, 30))
        ...
        self.btnSingle.setStyleSheet("color:red;")
