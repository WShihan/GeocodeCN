...
"border-radius: 5%;")
    ...
    def retranslateUi(self, GeocodeCNDialogBase):
        ...
        self.groupBox_6.setTitle(_translate("GeocodeCNDialogBase", "激活哪一个服务"))
        ...
        self.le_key_gaode.setText(_translate("GeocodeCNDialogBase", "高德地图密钥"))
        self.le_key_gaode.setPlaceholderText(_translate("GeocodeCNDialogBase", "Mapbox平台密钥"))
